...
Route::get('/recettes/{id}', [RecetteController::class, 'show'])->name('recettes.show')->where('id', '[0-9]+');
...
Route::get('/recettes/{category?}', [RecetteController::class, 'index'])->name('recettes.index');
